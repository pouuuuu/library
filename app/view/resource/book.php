...
<head>
    ...
    <title><?= htmlspecialchars($book->getTitle()) ?> - SAÉ E-Library</title>
            ...
            <div class="resource-content">
                <div class="resource-poster">
                    <?php if ($book->getPoster()): ?>
                        <img src="<?= htmlspecialchars($book->getPoster()) ?>" alt="<?= htmlspecialchars($book->getTitle()) ?>">
                    <?php else: ?>
                ...
                <div class="resource-info">
                    ...
                    <div class="emprunt-section" style="margin: 20px 0;">
                        ...
                        <?php else: ?>
                            <form method="POST" action="<?= htmlspecialchars($indexUrl) ?>?route=emprunt/emprunter" style="display: inline;">
                                <input type="hidden" name="idLivre" value="<?= htmlspecialchars($idBookForView ?? $book->getId()) ?>">
                    ...
                    <div class="resource-details">
                        <?php if ($book->getAuthors() && count($book->getAuthors()) > 0): ?>
                        <p><strong>Auteurs :</strong> <?= htmlspecialchars(implode(', ', $book->getAuthors())) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getPublishYear()): ?>
                        <p><strong>Année de publication :</strong> <?= htmlspecialchars($book->getPublishYear()) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getEditor()): ?>
                        <p><strong>Éditeur :</strong> <?= htmlspecialchars($book->getEditor()) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getIsbn()): ?>
                        <p><strong>ISBN :</strong> <?= htmlspecialchars($book->getIsbn()) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getNbPages()): ?>
                        <p><strong>Nombre de pages :</strong> <?= htmlspecialchars($book->getNbPages()) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getLanguage()): ?>
                        <p><strong>Langue :</strong> <?= htmlspecialchars($book->getLanguage()) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getEdition()): ?>
                        <p><strong>Édition :</strong> <?= htmlspecialchars($book->getEdition()) ?></p>
                        <?php endif; ?>

                        <?php if ($book->getPrice()): ?>
                        <p><strong>Prix :</strong> <?= htmlspecialchars($book->getPrice()) ?> €</p>
                        <?php endif; ?>
